...
ALLOWED_TRACKED_MARKDOWN = {
    ...
    "public-skills/dealwatch-readonly-builder/README.md",
    "public-skills/dealwatch-readonly-builder/SKILL.md",
    "public-skills/dealwatch-readonly-builder/references/mcp-install.md",
    "public-skills/dealwatch-readonly-builder/references/tool-map.md",
    "public-skills/dealwatch-readonly-builder/references/example-tasks.md",
