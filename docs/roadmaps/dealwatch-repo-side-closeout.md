...
- the old canonical repo is no longer the public source of truth
...
- the rebuilt repo keeps the current public entry `xiaojiou176/dealwatch`
- the old public repo was retired into a non-canonical archive path
...
| Old repo role | private archive / rollback asset |
| Open PRs | `0` |
| Open issues | `0` |
...
The earlier release objects and legacy tag story belong to the private archive repo, not the rebuilt public repo.
